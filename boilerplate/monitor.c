 ...
 * in process context (softirq-safe workqueue would need spinlock,
 * but mod_timer callbacks run in softirq context — we use
 * mutex_trylock in the callback to stay safe).
 * --------------------------------------------------------------- */
...
static void timer_callback(struct timer_list *t)
{
    ...
    /*
     * Use mutex_trylock: if something else holds the lock we simply
     * skip this tick rather than sleeping in an atomic context.
     */
